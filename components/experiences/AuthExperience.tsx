                ...
                return (
                  <button
                    ...
                    className={`rounded-lg px-3 py-1.5 text-sm font-bold transition active:scale-95 ${
                      on ? "bg-indigo-600 text-white" : "text-gray-600 ring-1 ring-gray-300"
                    }`}
                  >
                    {on ? "✓ " : ""}
                    {it.label}
    ...
    <div className="space-y-5">
      ...
      <Panel>
        ...
        <div className="mt-3 flex items-center justify-center gap-1 text-center">
          ...
          <div className="flex-1 rounded-xl bg-indigo-50 px-2 py-2.5 ring-1 ring-indigo-200">
            <div className="text-sm font-extrabold text-indigo-700">① 認証</div>
          ...
          <div className="flex-1 rounded-xl bg-emerald-50 px-2 py-2.5 ring-1 ring-emerald-200">
            <div className="text-sm font-extrabold text-emerald-700">② 認可</div>
        ...
        <ul className="mt-3 space-y-2 text-sm">
          <li className="rounded-xl bg-gray-50 px-3 py-2 ring-1 ring-gray-200">
            <b className="text-indigo-700">認証</b>（Authentication）＝<b>本人確認</b>。「あなたは誰？」
          </li>
          <li className="rounded-xl bg-gray-50 px-3 py-2 ring-1 ring-gray-200">
