  ...
  return (
    <DeckContext.Provider value={deck}>
      <div
        ...
        className="touch-pan-y rounded-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-500"
      >
              ...
              {ids.map((id, index) => (
                <button
                  ...
                  className={`h-2.5 w-2.5 rounded-full transition ${
                    index === active ? "bg-brand-600" : "bg-gray-200 hover:bg-brand-200"
                  }`}
                />
              ))}
            </div>
