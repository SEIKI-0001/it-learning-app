...
export const ipaSyllabusItems = [
  ...
  },
  {
    ...
    topicIds: ["strat-legal-compliance", "strat-privacy-law"], status: "covered",
    note: "コンプライアンス、情報倫理、個人情報保護、プライバシーに関する基本ルールを学ぶ。",
  },
  {
    id: "ipa-08", number: 8, field: "strategy", majorCategory: "企業と法務", middleCategory: "法務",
    item: "標準化関連", topicIds: ["strat-standardization"], status: "covered",
  ...
  },
  {
    ...
    item: "マーケティング", topicIds: ["strat-marketing-4p"], status: "covered",
    note: "市場調査、セグメンテーション、ターゲティング、ポジショニング、4Pを学ぶ。",
  },
  {
    id: "ipa-11", number: 11, field: "strategy", majorCategory: "経営戦略", middleCategory: "経営戦略マネジメント",
    item: "ビジネス戦略と目標・評価",
    topicIds: ["strat-corporate-strategy", "strat-goal-evaluation"], status: "covered",
  ...
  },
  {
    ...
    item: "経営管理システム", topicIds: ["strat-management-systems"], status: "expanded",
  ...
  },
  {
    ...
    item: "エンジニアリングシステム",
    topicIds: ["strat-engineering-systems", "strat-production-management"], status: "new",
  ...
  },
  {
    ...
    item: "e-ビジネス", topicIds: ["strat-ebusiness"], status: "covered",
  ...
  },
  {
    ...
    topicIds: ["tech-iot", "strat-embedded-systems"], status: "new",
  ...
  },
  {
    ...
    item: "開発プロセス・手法", topicIds: ["mgmt-development-process"], status: "covered",
  ...
  },
  {
    ...
    item: "サービスマネジメント",
    topicIds: ["mgmt-service-sla", "mgmt-itil"], status: "covered",
  ...
  },
  {
    ...
    item: "サービスマネジメントシステム",
    topicIds: ["mgmt-itil", "mgmt-service-sla"], status: "covered",
  ...
  },
  {
    ...
    item: "情報に関する理論",
    topicIds: ["tech-binary-data", "tech-multimedia-compression", "tech-ai-ml"], status: "covered",
  ...
  },
  {
    ...
    item: "データ構造", topicIds: ["tech-data-structure"], status: "covered",
  ...
  },
  {
    ...
    item: "アルゴリズムとプログラミング",
    topicIds: ["tech-algorithm-flowchart"], status: "covered",
  ...
  },
  {
    ...
    item: "プログラム言語", topicIds: ["tech-programming-basics"], status: "expanded",
  ...
  },
  {
    ...
    item: "その他の言語", topicIds: ["tech-programming-basics"], status: "expanded",
  ...
  },
  {
    ...
    item: "プロセッサ",
    topicIds: ["tech-computer-core", "tech-parallel-systems"], status: "new",
  ...
  },
  {
    ...
    item: "メモリ", topicIds: ["tech-computer-core"], status: "covered",
  ...
  },
  {
    ...
    item: "入出力デバイス", topicIds: ["tech-io-devices"], status: "expanded",
  ...
  },
  {
    ...
    item: "システムの構成",
    topicIds: ["tech-system-processing-architecture", "tech-raid", "tech-cloud-models"], status: "new",
  ...
  },
  {
    ...
    item: "システムの評価指標",
    topicIds: ["tech-system-performance", "tech-reliability-availability"], status: "new",
  ...
  },
  {
    ...
    item: "オペレーティングシステム", topicIds: ["tech-os-software-hardware"], status: "expanded",
  ...
  },
  {
    ...
    item: "ファイルシステム", topicIds: ["tech-file-system", "tech-backup"], status: "new",
  ...
  },
  {
    ...
    item: "オフィスツール",
    topicIds: ["tech-os-software-hardware", "tech-spreadsheet"], status: "expanded",
  ...
  },
  {
    ...
    item: "オープンソースソフトウェア", topicIds: ["tech-os-software-hardware"], status: "expanded",
  ...
  },
  {
    ...
    topicIds: ["tech-computer-types", "tech-computer-core", "tech-io-devices"], status: "new",
  ...
  },
  {
    ...
    item: "情報デザイン", topicIds: ["tech-ui-ux"], status: "expanded",
  ...
  },
  {
    ...
    item: "インタフェース設計", topicIds: ["tech-ui-ux"], status: "covered",
  ...
  },
  {
    ...
    item: "マルチメディア技術", topicIds: ["tech-multimedia-compression"], status: "covered",
    note: "画像・音声・動画のデジタル化、解像度、色、代表的な圧縮方式を学ぶ。",
  },
  {
    id: "ipa-53", number: 53, field: "technology", majorCategory: "技術要素", middleCategory: "情報メディア",
    item: "マルチメディア応用", topicIds: ["tech-multimedia-compression"], status: "expanded",
  ...
  },
  {
    ...
    item: "トランザクション処理", topicIds: ["tech-transaction"], status: "covered",
    note: "ACID特性、コミット・ロールバック、排他制御、障害時の回復を学ぶ。",
  },
  {
    id: "ipa-58", number: 58, field: "technology", majorCategory: "技術要素", middleCategory: "ネットワーク",
    item: "ネットワーク方式",
    topicIds: ["tech-lan-wan", "tech-network-devices", "tech-wireless-mobile"], status: "new",
  ...
  },
  {
    ...
    item: "通信プロトコル",
    topicIds: ["tech-web-internet-basics", "tech-http-https", "tech-email-protocol"], status: "covered",
  ...
  },
  {
    ...
    item: "ネットワーク応用",
    topicIds: ["tech-network-address", "tech-api", "tech-cloud-models"], status: "covered",
  ...
  },
  {
    ...
    item: "情報セキュリティ",
    topicIds: ["tech-security-cia", "tech-malware-phishing-ransomware", "tech-cyber-attacks"], status: "covered",
  ...
  },
  {
    ...
    item: "情報セキュリティ管理", topicIds: ["tech-isms-risk"], status: "covered",
