...
export type IpaSyllabusField = "strategy" | "management" | "technology";
export type IpaSyllabusCoverage = "covered" | "expanded" | "new";

export type IpaSyllabusItem = {
  id: `ipa-${string}`;
  number: number;
  field: IpaSyllabusField;
  majorCategory: string;
  middleCategory: string;
  name: string;
  topicIds: readonly string[];
  coverage: IpaSyllabusCoverage;
  note: string;
};
...
export const ipaSyllabusItems = [
  ...
  },
  {
    ...
    name: "標準化関連", topicIds: ["strat-standardization"], coverage: "covered",
  ...
  },
  {
    ...
    name: "マーケティング", topicIds: ["strat-marketing-4p"], coverage: "covered",
  ...
  },
  {
    ...
    name: "ビジネスシステム", topicIds: ["strat-business-systems"], coverage: "new",
  ...
  },
  {
    ...
    name: "e-ビジネス", topicIds: ["strat-ebusiness"], coverage: "covered",
  ...
  },
  {
    ...
    name: "情報システム戦略", topicIds: ["strat-system-strategy"], coverage: "expanded",
    note: "経営戦略と整合した情報システム戦略、全体最適化、導入方針を学ぶ。",
  },
  {
    id: "ipa-19", number: 19, field: "strategy", majorCategory: "システム戦略", middleCategory: "システム戦略",
    name: "業務プロセス", topicIds: ["strat-business-process"], coverage: "expanded",
  ...
  },
  {
    ...
    name: "システム活用促進・評価", topicIds: ["strat-system-strategy"], coverage: "expanded",
    note: "利用者教育、導入促進、IT投資評価、導入後の効果測定と改善を学ぶ。",
  },
  {
    id: "ipa-22", number: 22, field: "strategy", majorCategory: "システム戦略", middleCategory: "システム企画",
    name: "システム化計画", topicIds: ["strat-system-planning-rfp"], coverage: "covered",
  ...
  },
  {
    ...
    name: "調達計画・実施", topicIds: ["strat-system-planning-rfp"], coverage: "covered",
  ...
  },
  {
    ...
    name: "開発プロセス・手法", topicIds: ["mgmt-development-process"], coverage: "covered",
  ...
  },
  {
    ...
    name: "ファシリティマネジメント", topicIds: ["mgmt-facility-management"], coverage: "covered",
    note: "設備、電源、UPS、入退室、災害対策などIT環境の維持管理を学ぶ。",
  },
  {
    id: "ipa-31", number: 31, field: "management", majorCategory: "サービスマネジメント", middleCategory: "システム監査",
    name: "システム監査", topicIds: ["mgmt-system-audit"], coverage: "covered",
  ...
  },
  {
    ...
    name: "内部統制", topicIds: ["mgmt-system-audit"], coverage: "covered",
    note: "内部統制の目的、職務分掌、承認、記録など業務を適切に保つ統制活動を学ぶ。",
  },
  {
    id: "ipa-33", number: 33, field: "technology", majorCategory: "基礎理論", middleCategory: "基礎理論",
    name: "離散数学", topicIds: ["tech-binary-data", "tech-logic-operations"], coverage: "covered",
    note: "2進数などの基数変換、集合・論理演算、真理値表の基礎を学ぶ。",
  },
  {
    id: "ipa-34", number: 34, field: "technology", majorCategory: "基礎理論", middleCategory: "基礎理論",
    name: "応用数学", topicIds: ["tech-data-utilization"], coverage: "covered",
    note: "平均・中央値・分散などの統計量と、データを読み取る基礎を学ぶ。",
  },
  {
    id: "ipa-35", number: 35, field: "technology", majorCategory: "基礎理論", middleCategory: "基礎理論",
    name: "情報に関する理論",
    topicIds: ["tech-binary-data", "tech-multimedia-compression"], coverage: "covered",
    note: "情報量とデータ量の単位、符号化、画像・音声データと圧縮の考え方を学ぶ。",
  },
  {
    id: "ipa-36", number: 36, field: "technology", majorCategory: "基礎理論", middleCategory: "アルゴリズムとプログラミング",
    name: "データ構造", topicIds: ["tech-data-structure"], coverage: "covered",
  ...
  },
  {
    ...
    name: "プログラム言語", topicIds: ["tech-programming-basics"], coverage: "expanded",
  ...
  },
  {
    ...
    name: "その他の言語", topicIds: ["tech-programming-basics"], coverage: "expanded",
  ...
  },
  {
    ...
    name: "メモリ", topicIds: ["tech-computer-core"], coverage: "covered",
  ...
  },
  {
    ...
    name: "入出力デバイス", topicIds: ["tech-io-devices"], coverage: "expanded",
  ...
  },
  {
    ...
    name: "オペレーティングシステム", topicIds: ["tech-os-software-hardware"], coverage: "expanded",
  ...
  },
  {
    ...
    name: "ファイルシステム", topicIds: ["tech-file-system", "tech-backup"], coverage: "new",
  ...
  },
  {
    ...
    name: "オープンソースソフトウェア", topicIds: ["tech-os-software-hardware"], coverage: "expanded",
  ...
  },
  {
    ...
    name: "情報デザイン", topicIds: ["tech-ui-ux"], coverage: "covered",
    note: "情報を目的に合わせて整理し、分かりやすく伝えるレイアウトや表現方法を学ぶ。",
  },
  {
    id: "ipa-51", number: 51, field: "technology", majorCategory: "技術要素", middleCategory: "情報デザイン",
    name: "インタフェース設計", topicIds: ["tech-ui-ux"], coverage: "covered",
    note: "ユーザビリティ、アクセシビリティ、ユニバーサルデザイン、GUI部品の使い分けを学ぶ。",
  },
  {
    id: "ipa-52", number: 52, field: "technology", majorCategory: "技術要素", middleCategory: "情報デザイン",
    name: "マルチメディア技術", topicIds: ["tech-multimedia-compression"], coverage: "covered",
    note: "画像・音声・動画のデジタル化、解像度、色、代表的な圧縮方式を学ぶ。",
  },
  {
    id: "ipa-53", number: 53, field: "technology", majorCategory: "技術要素", middleCategory: "情報デザイン",
    name: "マルチメディア応用", topicIds: ["tech-multimedia-compression"], coverage: "covered",
    note: "マルチメディアコンテンツの制作・配信と、用途に応じたデータ形式・圧縮の選択を学ぶ。",
  },
  {
  ...
  },
  {
    ...
    name: "データ操作", topicIds: ["tech-database-sql"], coverage: "covered",
  ...
  },
  {
    ...
    name: "トランザクション処理", topicIds: ["tech-transaction"], coverage: "covered",
