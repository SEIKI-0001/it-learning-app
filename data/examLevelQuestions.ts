...
// ============================================================================
// 【凍結】このファイルはもう出題に使われていない。
// ----------------------------------------------------------------------------
// 問題データの正は data/question-bank/original/exam-level.json（統一問題バンク）。
// 出題・取得は lib/questionBank 経由で行う（lib/checkPack.ts はそちらを見ている）。
//
// ここに残しているのは、移行前後で ID・問題文・選択肢・正答・解説・difficulty・
// examTags が変わっていないことを test/questionBank.test.ts で突き合わせるため。
// 問題の追加・修正はこのファイルではなく問題バンク側に対して行うこと。
// 照合が不要になった時点でこのファイルは削除してよい。
// ============================================================================
